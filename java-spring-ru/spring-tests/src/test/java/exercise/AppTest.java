...
public class AppTest {
    ...
    void testUpdatePerson() throws Exception {
        ...
        person.setFirstName("Picasso");
        person.setLastName("Padlo");
        MockHttpServletResponse patchResponse = mockMvc
                .perform(MockMvcRequestBuilders.patch("/people/{id}", 1)
                        .contentType(MediaType.APPLICATION_JSON)
        ...
        assertThat(getResponse.getContentAsString()).contains("Picasso", "Padlo");
    }
    ...
    void deletePerson() throws Exception {
        ...
        assertThat(getResponse.getStatus()).isEqualTo(200);
        assertThat(getResponse.getContentType()).isEqualTo(MediaType.APPLICATION_JSON.toString());
        assertThat(getResponse.getContentAsString()).contains("John", "Smith");
        ...
        assertThat(getAllResponse.getContentType()).isEqualTo(MediaType.APPLICATION_JSON.toString());
        assertThat(getAllResponse.getContentAsString()).doesNotContain("John", "Smith");
    }
    // END
}
